...
const extraLiteralTranslations: LiteralTranslationMap = {
  ...
  "Move funds between cash/bank accounts.":
    "انقل الأموال بين حسابات الصندوق والبنك.",
  "From Account *": "من حساب *",
  "To Account *": "إلى حساب *",
  "Select source": "اختر المصدر",
  "Select destination": "اختر الوجهة",
  "Transfer description": "وصف التحويل",
  "Add Cash/Bank Account": "إضافة حساب صندوق/بنك",
  "Create a new cash or bank account.": "أنشئ حساب صندوق أو بنك جديدًا.",
  "COA Account *": "حساب دليل الحسابات *",
  "Link to COA": "الربط بدليل الحسابات",
  "Total Balance": "إجمالي الرصيد",
  "Add your first cash or bank account": "أضف أول حساب صندوق أو بنك",
  "Expense not found": "لم يتم العثور على المصروف",
  "Pay Expense": "سداد المصروف",
  "Pay From *": "السداد من *",
  "Record a business expense": "تسجيل مصروف أعمال",
  ...
  "Loading entry...": "جارٍ تحميل القيد...",
  "Modify existing journal entry": "تعديل القيد اليومي الحالي",
  "Line description": "وصف السطر",
  "Totals:": "الإجماليات:",
  "Entry not found": "لم يتم العثور على القيد",
  "Fix Customer Balances": "إصلاح أرصدة العملاء",
  "Balance Checker": "فاحص الأرصدة",
  "Check Results": "نتائج الفحص",
  "Customers with Balance Issues": "العملاء ذوو مشاكل الأرصدة",
  "Stored Balance": "الرصيد المخزن",
  "Calculated Balance": "الرصيد المحتسب",
  "Fixed Balances": "الأرصدة المصححة",
  "New Balance": "الرصيد الجديد",
  "Fix Product Costs": "إصلاح تكاليف الأصناف",
  "Product Cost Checker": "فاحص تكلفة الأصناف",
  "Products with Incorrect Costs": "الأصناف ذات التكاليف غير الصحيحة",
  "Current Cost": "التكلفة الحالية",
  "Correct MRP": "سعر البيع الصحيح",
  "Latest Invoice": "أحدث فاتورة",
  "Fixed Product Costs": "تكاليف الأصناف المصححة",
  "Old Cost": "التكلفة السابقة",
  "New Cost (MRP)": "التكلفة الجديدة (سعر البيع)",
  "Sidebar Configuration": "تهيئة الشريط الجانبي",
  "Enter password": "أدخل كلمة المرور",
  "Select organization": "اختر المنشأة",
  "15-digit GST Identification Number": "رقم تعريف GST مكوّن من 15 رقمًا",
  "Update sales return details": "تحديث تفاصيل مرتجع المبيعات",
  "Original Invoice (Optional)": "الفاتورة الأصلية (اختياري)",
  "Leave blank for standalone credit note":
    "اتركه فارغًا لإشعار دائن مستقل",
  "e.g., Damaged goods": "مثال: بضاعة تالفة",
  "Total Return:": "إجمالي المرتجع:",
  "Loading credit note...": "جارٍ تحميل الإشعار الدائن...",
  "Credit note not found": "لم يتم العثور على الإشعار الدائن",
  "Back to Credit Notes": "العودة إلى الإشعارات الدائنة",
  "Customer Information": "معلومات العميل",
  "Credit Note Information": "معلومات الإشعار الدائن",
  "Created By": "أُنشئ بواسطة",
  "Loading statement...": "جارٍ تحميل كشف الحساب...",
  "Statement not found": "لم يتم العثور على كشف الحساب",
  "Enter amount (positive for receivable)":
    "أدخل المبلغ (الموجب يمثل مستحقات)",
  "Assign Customer": "إسناد العميل",
  "No users available for assignment.":
    "لا يوجد مستخدمون متاحون للإسناد.",
  "Loading debit note...": "جارٍ تحميل الإشعار المدين...",
  "Debit note not found": "لم يتم العثور على الإشعار المدين",
  "Back to Debit Notes": "العودة إلى الإشعارات المدينة",
  "Supplier Information": "معلومات المورد",
  "Debit Note Information": "معلومات الإشعار المدين",
  "Branches & Warehouses": "الفروع والمستودعات",
  "Manage your organization locations and storage facilities":
    "إدارة مواقع المنشأة ومرافق التخزين",
  "Stock Lots": "دفعات المخزون",
  ...
  "Set initial inventory quantities and values for your products":
    "تعيين كميات وقيم المخزون الافتتاحية للأصناف",
  "No Warehouse (Global)": "بدون مستودع (عام)",
  "No opening stock entries": "لا توجد قيود مخزون افتتاحي",
  'Click "Add Opening Stock" to set initial inventory':
    'اضغط "إضافة مخزون افتتاحي" لتعيين المخزون الافتتاحي',
  "Opening Qty": "الكمية الافتتاحية",
  "Add Opening Stock": "إضافة مخزون افتتاحي",
  "Warehouse (optional)": "المستودع (اختياري)",
  "All branches": "جميع الفروع",
  "Select a product": "اختر صنفًا",
  "Stock Date *": "تاريخ المخزون *",
  "Optional notes...": "ملاحظات اختيارية...",
  "Grade A": "درجة A",
  "Grade B": "درجة B",
  "Grade C": "درجة C",
  "Delete Opening Stock": "حذف المخزون الافتتاحي",
  "Transfer stock between warehouses and track movements":
    "تحويل المخزون بين المستودعات وتتبع الحركات",
  "Transfer #": "رقم التحويل",
  "Source Warehouse *": "المستودع المصدر *",
  "Destination Warehouse *": "المستودع الوجهة *",
  "Scan to verify invoice (ZATCA Phase 1)":
    "امسح للتحقق من الفاتورة (زاتكا - المرحلة الأولى)",
  "ZATCA Compliant QR": "رمز QR متوافق مع زاتكا",
  "VAT Invoice (ZATCA Phase 1)": "فاتورة ضريبية (زاتكا - المرحلة الأولى)",
  "No devices in stock for this product":
    "لا توجد أجهزة متوفرة لهذا الصنف",
  "No devices in stock": "لا توجد أجهزة في المخزون",
  "Manage individual mobile devices": "إدارة أجهزة الجوال الفردية",
  "Brand / Model": "العلامة التجارية / الطراز",
  Selling: "سعر البيع",
  "Search for a device by scanning or entering its IMEI number":
    "ابحث عن جهاز عبر المسح أو إدخال رقم IMEI",
  "Scan or enter IMEI number...": "امسح أو أدخل رقم IMEI...",
  "Device Not Found": "لم يتم العثور على الجهاز",
  "No device matches IMEI:": "لا يوجد جهاز يطابق IMEI:",
  "Inventory & Condition": "المخزون والحالة",
  "Battery Health": "صحة البطارية",
  "Cost & Sourcing": "التكلفة والتوريد",
  "Inward Date": "تاريخ الإدخال",
  "Cost Price": "سعر التكلفة",
  "Landed Cost": "التكلفة الواصلة",
  "Sales Details": "تفاصيل البيع",
  "Sales Invoice": "فاتورة المبيعات",
  "Outward Date": "تاريخ الصرف",
  "Sold Price": "سعر البيع",
  "Not sold yet": "لم يتم بيعه بعد",
  "Supplier Warranty": "ضمان المورد",
  "Customer Warranty": "ضمان العميل",
  "Filter by status": "التصفية حسب الحالة",
  "Record Supplier Payment": "تسجيل دفعة مورد",
  "Link to Purchase Invoice (Optional)":
    "ربط بفاتورة المشتريات (اختياري)",
  "Discount Given": "الخصم الممنوح",
  Adjustment: "التسوية",
  "Adjustment Account *": "حساب التسوية *",
  "Set Opening Balance": "تعيين الرصيد الافتتاحي",
  "Opening Balance Amount *": "مبلغ الرصيد الافتتاحي *",
  "Enter amount (positive for payable)":
    "أدخل المبلغ (الموجب يمثل مستحقًا للدفع)",
  "15-digit GSTIN": "رقم GSTIN مكوّن من 15 رقمًا",
  "GST State Code": "رمز ولاية GST",
  "IMEI 1 *": "IMEI 1 *",
  Identifiers: "المعرفات",
  Specifications: "المواصفات",
  "15-digit IMEI": "IMEI مكوّن من 15 رقمًا",
  Unlocked: "مفتوح الشبكة",
  Locked: "مقفل الشبكة",
  ...
  "Scan IMEI Barcode": "امسح باركود IMEI",
  "IMEI Detected": "تم اكتشاف IMEI",
  "Global Unit Conversions": "تحويلات الوحدات العامة",
  "Alternate Unit (From) *": "الوحدة البديلة (من) *",
  "Select unit (e.g. Box)": "اختر الوحدة (مثال: صندوق)",
  "Base Unit (To) *": "الوحدة الأساسية (إلى) *",
  "Select base unit (e.g. Piece)":
    "اختر الوحدة الأساسية (مثال: قطعة)",
  "Conversion Factor (Multiplier) *": "معامل التحويل (المضاعف) *",
  "No conversion rules": "لا توجد قواعد تحويل",
  Rule: "القاعدة",
  "From Unit": "من وحدة",
  "To Base Unit": "إلى الوحدة الأساسية",
  "Activate unit": "تفعيل الوحدة",
  "Command Palette": "لوحة الأوامر",
  "Thank you for your visit!": "شكرًا لزيارتكم!",
  "Thank you for your purchase!": "شكرًا لشرائكم!",
  "Select account": "اختر الحساب",
  "Select branch": "اختر الفرع",
  "Select product": "اختر الصنف",
  "Update quotation details": "تحديث تفاصيل عرض السعر",
  "Settlement Accounts": "حسابات التسوية",
  "Weigh Machine Code": "رمز ميزان الوزن",
  "Stock Validation:": "التحقق من المخزون:",
  "This action is irreversible and should be done with caution.":
    "هذا الإجراء غير قابل للتراجع ويجب تنفيذه بحذر.",
  "This action is irreversible and should be done with extreme caution.":
    "هذا الإجراء غير قابل للتراجع ويجب تنفيذه بحذر شديد.",
  "3XXXXXXXXXXXXXX (15 digits)": "3XXXXXXXXXXXXXX (15 رقمًا)",
