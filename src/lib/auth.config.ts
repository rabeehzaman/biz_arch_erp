  ...
  callbacks: {
    ...
    async jwt({ token, user, trigger, session: sessionUpdate }) {
      if (user) {
        ...
        token.isSocketIOEnabled = (user as { isSocketIOEnabled?: boolean }).isSocketIOEnabled ?? false;
        token.isManufacturingModuleEnabled = (user as { isManufacturingModuleEnabled?: boolean }).isManufacturingModuleEnabled ?? false;
      ...
      if (trigger === "update" && sessionUpdate) {
        ...
        if (update.switchOrgContext) {
          ...
          token.isSocketIOEnabled = ctx.isSocketIOEnabled as boolean ?? false;
          token.isManufacturingModuleEnabled = ctx.isManufacturingModuleEnabled as boolean ?? false;
    ...
    async session({ session, token }) {
      if (session.user) {
        ...
        (session.user as { isSocketIOEnabled?: boolean }).isSocketIOEnabled = token.isSocketIOEnabled as boolean;
        (session.user as { isManufacturingModuleEnabled?: boolean }).isManufacturingModuleEnabled = token.isManufacturingModuleEnabled as boolean;
