...
import type { PurchaseRegisterData } from "@/lib/reports/purchase-register";

interface PurchaseRegisterPDFProps {
  organization: {
    name: string;
...
const labels = {
  en: {
    ...
    noData: "No purchase invoices found for this period.",
    page: "Page",
  ...
  ar: {
    ...
    noData: "\u0644\u0627 \u062A\u0648\u062C\u062F \u0641\u0648\u0627\u062A\u064A\u0631 \u0645\u0634\u062A\u0631\u064A\u0627\u062A \u0644\u0647\u0630\u0647 \u0627\u0644\u0641\u062A\u0631\u0629.",
    page: "\u0635\u0641\u062D\u0629",
...
const buildStyles = (brandColor: string, isRTL: boolean) =>
  StyleSheet.create({
    ...
    colSupplier: { width: "15%", paddingRight: 4 },
...
export function PurchaseRegisterPDF({
  organization,
  data,
  fromDate,
  toDate,
  lang,
}: PurchaseRegisterPDFProps) {
  const isRTL = lang === "ar";
  const l = labels[lang];
      ...
      <Page size="A4" orientation="landscape" style={styles.page} wrap>
        ...
        <View style={styles.heroStats}>
          <View style={styles.heroCard}>
            <Text style={styles.heroLabel}>{l.totalPurchases}</Text>
            <Text style={styles.heroValueRed}>
              {formatAmount(data.totals.total, currency)}
            </Text>
          </View>
          <View style={styles.heroCard}>
            <Text style={styles.heroLabel}>{l.paid}</Text>
