    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.title}>كشف حساب المورد</Text>
        ...
        <View style={styles.summaryRow}>
          ...
          <View style={styles.summaryItem}>
            <Text style={styles.summaryLabel}>إجمالي المستحق الدفع</Text>
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.colDebit, styles.headerText]}>المستحق الدفع</Text>
            <Text style={[styles.colCredit, styles.headerText]}>المدفوع</Text>
