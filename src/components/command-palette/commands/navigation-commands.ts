...
export const jewelleryShopNav: NavDef[] = [
  ...
  { name: "Purchase Jewellery Stock", href: "/purchase-invoices/new", icon: Truck, keywords: ["buy", "purchase", "supplier", "stock in", "receive"], requiresFeature: ["isJewelleryModuleEnabled"] },
...
export const reportsNav: NavDef[] = [
  ...
  { name: "Purchase Register", href: "/reports/purchase-register", icon: FileText, keywords: ["purchase list", "all purchases", "bill list"] },
  { name: "Purchases by Supplier", href: "/reports/purchases-by-supplier", icon: BarChart3, keywords: ["supplier purchases", "vendor spending"] },
  { name: "Purchases by Item", href: "/reports/purchases-by-item", icon: BarChart3, keywords: ["product purchases", "item cost", "quantity purchased"] },
  ...
  { name: "VAT Detail", href: "/reports/vat-detail", icon: Percent, keywords: ["VAT invoices", "tax detail", "invoice level VAT"], edition: "SAUDI" },
  { name: "GST Summary", href: "/reports/gst-summary", icon: Percent, keywords: ["goods services tax", "tax report", "GST"], edition: "INDIA" },
  { name: "GST Detail", href: "/reports/gst-detail", icon: Percent, keywords: ["GST invoices", "tax detail", "invoice level GST"], edition: "INDIA" },
